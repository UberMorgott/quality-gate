...
Cohesion: 0.05
Nodes (33): Find-Marker(), Get-ChecksHash(), Get-CustomChecks(), Get-DefaultTrustStore(), Get-DeployEntries(), Get-DirBytes(), Get-GitIgnoredSet(), Get-GoBuiltWith() (+25 more)

### Community 2 - ".golangci.yml template"
Cohesion: 0.05
...
Cohesion: 0.08
Nodes (48): Fail(), Get-ChangedPaths(), Get-CppCompileDb(), Get-CppGeneratedIncludes(), Get-Descendants(), Get-DotnetChangedCs(), Get-DotnetEval(), Get-DotnetFolderFormat() (+40 more)
...
### Community 44 - "quality_gate job anchor shared by both hooks"
Cohesion: 0.17
...
### Community 55 - "Coverage measures happy paths; a green suite proves nothing"
Cohesion: 0.17
